...
<div class="container">
  ...
  $c=0;
      ...
      {
        $sql="SELECT student.username,roll,books.name,authors,edition,issuedate,returndate FROM student inner join issue_book ON student.username=issue_book.username inner join books ON issue_book.name=books.name WHERE issue_book.approve ='Yes' ORDER BY returndate ASC";
