...
<div id="main">
  ...
  <div class="container" style="text-align: center";>
    <h2 style="color: black; font-family: Lucida Console; text-align: center">Add New Books</h2><br>
    <form class="book" action="" method="post">
      <input type="text" name="name" class="form-control"; placeholder="Name Of The Book" required=""><br>
      ...
      <button class="btn btn-default" type="submit" name="submit">Add Book</button>
    </form>
