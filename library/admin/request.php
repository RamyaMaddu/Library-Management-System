...
{
	$sql="SELECT student.username,roll,books.name,authors,edition,status FROM student inner join issue_book ON student.username=issue_book.username inner join books ON issue_book.name=books.name WHERE issue_book.approve =''";
	$res=mysqli_query($db,$sql);

	if(mysqli_num_rows($res)==0)
		{
			echo "<h2><b>";
			echo "There's is no pending request";
			echo "<h2><b>";
		}
	else
	{
