...
function closeNav() {
  ...
  document.body.style.backgroundColor = "white";
	...
	<!--____________________________________search bar___________________________________________-->
	<div class="search">
	...
	<!--____________________________________request book_______________________________________-->
	<div class="search">
		<form class="navbar-form" method="post" name="form1">
...
echo "<table class='table table-bordered table-hover'>";
	...
	if(isset($_POST['submit1']))
	{
		...
		{
			mysqli_query($db,"INSERT INTO issue_book Values('$_SESSION[login_user]', '$_POST[name]', '', '', '');");
			?>
